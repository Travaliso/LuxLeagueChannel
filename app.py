...
START_YEAR = 2021  # <--- UPDATE THIS TO YOUR START YEAR
...
def run_monte_carlo_simulation(_league, simulations=1000):
    ...
    final_output = []
    for team in _league.teams:
        odds = (results[team.team_name] / simulations) # Decimal 0-1
...
# --- [3.8] NEXT GEN LAB (FIXED & ROBUST) ---
@st.cache_data(ttl=3600 * 12) 
def load_nextgen_data_v3(year):
    # Fallback logic for finding data
