...
# ==============================================================================
# 1. CSS & STYLING (RESPONSIVE BREAKPOINTS)
# ==============================================================================
def inject_luxury_css():
    ...
    /* Make header transparent but keep buttons clickable */
    ...
    /* DESKTOP (Default): No special overrides needed, utilizes layout="wide" */

    /* MOBILE (Max Width 800px) */
    @media (max-width: 800px) {
        /* Adjust padding to reclaim screen space */
        .block-container {
        ...
        /* Metric values shouldn't overflow */
...
def create_download_link(val, filename):
    ...
    return f'<a href="data:application/octet-stream;base64,{b64.decode()}" download="{filename}">Download Executive Briefing (PDF)</a>'import streamlit as st
from espn_api.football import League
import pandas as pd
import numpy as np
import requests
